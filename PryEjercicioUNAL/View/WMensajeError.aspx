<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/HomeMaster.Master" AutoEventWireup="true" CodeFile="WMensajeError.aspx.cs" Inherits="View_WMensajeError" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <body>
        <div class=&quot;container&quot;>
            <h2><span>500</span>   Acceso Denegado</h2>
            <p>.<br /><br />Su perfil no tiene acceso a esta página, por favor comuniquese con el administrador de sistemas .</p>
        </div>
    </body>
</html>
